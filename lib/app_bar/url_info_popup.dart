...
import 'package:web_browser/app_bar/certificates_info_popup.dart';
                  ...
                  child: RichText(
                    ...
                    text: TextSpan(
                      children: <TextSpan>[
                        ...
                        TextSpan(
                            text: webViewModel.url.trim() == "about:blank"
                                ? ':'
                                : '://',
                        ...
                        TextSpan(
                            ...
                            style: defaultTextSpanStyle.copyWith(
                                color: Colors.black)),
                        TextSpan(text: uri.path, style: defaultTextSpanStyle),
                        TextSpan(
                            text: uri.query.isNotEmpty ? "?" + uri.query : "",
                            style: defaultTextSpanStyle),
                      ],
                    ),
                  )),
